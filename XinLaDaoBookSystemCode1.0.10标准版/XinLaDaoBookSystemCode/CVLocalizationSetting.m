...
-(UIImage *)imgWithContentsOfFile:(NSString *)imageName
{
    NSArray *docPaths =  NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES);
    NSString *docPath = [docPaths objectAtIndex:0];
    NSString *bigPath = [docPath stringByAppendingPathComponent:imageName];
    //    NSData *data = [[NSData alloc] initWithContentsOfFile:bigPath];
    UIImage *img = [[UIImage alloc] initWithData:[[NSData alloc] initWithContentsOfFile:bigPath]];
    return img;
}
