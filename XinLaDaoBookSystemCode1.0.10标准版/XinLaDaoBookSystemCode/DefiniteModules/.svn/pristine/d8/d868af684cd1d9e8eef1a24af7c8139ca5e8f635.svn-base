...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self addSubview:[self addNumericKeyWithTitle:@"删除" frame:CGRectMake(0, KeyboardNumericKeyHeight * 3 + 4, KeyboardNumericKeyWidth - 3, KeyboardNumericKeyHeight)]];
        
        [self addSubview:[self addNumericKeyWithTitle:@"完成" frame:CGRectMake(KeyboardNumericKeyWidth * 2 - 1, KeyboardNumericKeyHeight * 3 + 4, KeyboardNumericKeyWidth - 2, KeyboardNumericKeyHeight)]];
        ...
        [dengluButton setBackgroundImage:[UIImage imageNamed:@"TableButtonRed.png"] forState:UIControlStateNormal];
        ...
        [chongzhiButton setBackgroundImage:[UIImage imageNamed:@"TableButtonRed.png"] forState:UIControlStateNormal];
        [chongzhiButton setTitle:@"重置" forState:UIControlStateNormal];
...
- (UIButton *)addNumericKeyWithTitle:(NSString *)title frame:(CGRect)frame {
    ...
    [button setBackgroundImage:[UIImage imageNamed:@"shuzi.png"] forState:UIControlStateNormal];
