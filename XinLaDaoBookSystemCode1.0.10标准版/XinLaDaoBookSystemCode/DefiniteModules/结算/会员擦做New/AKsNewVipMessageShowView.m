...
//        button==btn?[button setBackgroundImage:[[CVLocalizationSetting sharedInstance] imgWithContentsOfFile:@"blackButton.png.png"] forState:UIControlStateNormal]:[button setBackgroundImage:[[CVLocalizationSetting sharedInstance] imgWithContentsOfFile:@"whiteButton.png"] forState:UIControlStateNormal];
    }
