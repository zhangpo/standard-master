...
- (id)initWithFrame:(CGRect)frame andName:(NSDictionary *)name andTag:(int )btnTag
{
    ...
    if (self) {
        ...
        _moneyField.text=[NSString stringWithFormat:@"%.2f",[[name objectForKey:@"OPERATEVALUE"] floatValue]];
